...
14. **N. Close with Offline Proof** - Close on no cloud APIs, local patient memory, local guidance, RealGemma text and vision, direct Gemma audio blocked, and CHW review/confirm/save always required.
