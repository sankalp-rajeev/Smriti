    ...
    companion object {
        ...
        fun summaryJson(summary: SupervisorSummary): String {
            return buildString {
                ...
                append("  \"open_follow_ups\": ${summary.openFollowUps},\n")
                append("  \"overdue_follow_ups\": ${summary.overdueFollowUps},\n")
                append("  \"due_today_follow_ups\": ${summary.dueTodayFollowUps},\n")
                append("  \"upcoming_follow_ups\": ${summary.upcomingFollowUps},\n")
